...
\usepackage[contentBlocks,rawAttribute,texMathDollars,pipeTables,html,fencedCode,strikeThrough,superscripts,subscripts,inlineNotes,definitionLists,hybrid]{markdown}
\usepackage{endnotes}
...
\newcommand{\mdstrikethrough}[1]{\textcolor{gray}{\sout{#1}}}
...
\newcommand{\mdcheckboxchecked}{%
    \makebox[2.2em][l]{%
        \tikz[baseline=0.2ex]{\draw[line width=0.5pt,rounded corners=1pt] (0,0) rectangle (1.8ex,1.8ex); \draw[line width=1.4pt] (0.3ex,0.9ex) -- (0.7ex,0.5ex) -- (1.5ex,1.3ex);}% 
        \hspace{0.2em}% 
    }% 
}
