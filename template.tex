    ...
    \ifx\templang\terminallang
      {
        ...
        \inputminted[fontsize=\footnotesize,breaklines,linenos=false,highlightcolor=codeHighlightBg]{text}{#1}
      }
    \else        
    % Plain text mode (no language specified)
    \edef\templang{#2}
    \ifx\templang\empty
    \inputminted[fontsize=\footnotesize,breaklines,linenos=false]{text}{#1}
    \else
    % Language-specific mode with optional extra options
    \def\extraopts{#5}
    \ifx\extraopts\empty
    \inputminted[fontsize=\footnotesize,breaklines,linenos=false,highlightcolor=codeHighlightBg]{#2}{#1}
    \else
    % With extra options
    \inputminted[fontsize=\footnotesize,breaklines,linenos=false,highlightcolor=codeHighlightBg,#5]{#2}{#1}
    \fi
    \fi
    \fi
  \end{tcolorbox}
