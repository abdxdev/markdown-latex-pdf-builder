    ...
    rendererPrototypes={
        ...
        inputFencedCode = {%
            ...
            \ifx\templang\empty%
                ...
                \end{tcolorbox}% 
            \else%                % Check if language is "output" for special first-line highlighting
                ...
                \ifx\templang\outputlang%
                    ...
                    {\def\FancyVerbFormatLine##1{\ifnum\value{FancyVerbLine}=1{\color{outputCommandFg}##1}\else##1\fi}\inputminted[fontsize=\footnotesize,breaklines=true,linenos=false]{text}{#1}}% 
                    \end{tcolorbox}%
                \else%
                    \begin{tcolorbox}[
                        enhanced,
