...
\definecolor{highlightBg}{RGB}{255,255,152} % Yellow highlight
...
% Keyboard shortcut styling (realistic keyboard keys with rounded corners and 3D effect)
\definecolor{keyBg}{RGB}{245,245,245}
\definecolor{keyBorder}{RGB}{160,160,160}
\definecolor{keyBottomBorder}{RGB}{100,100,100}

% Alert/Callout box colors (GitHub-style alerts)
...
% Alert box environments - using simpler tcolorbox without overlay to avoid nesting issues
% These will be triggered by special comment markers inserted by the Lua filter
...
% Keyboard key styling using tcolorbox for rounded corners and thick bottom
\newtcbox{\kbdkeybox}{
    on line,
    arc=2pt,
    colback=keyBg,
...
% Override default markdown task list renderers to use our custom checkboxes
