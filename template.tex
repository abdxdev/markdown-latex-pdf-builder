...
\usepackage{titlesec}
\usepackage{datetime}
\usepackage[highlightmode=immediate]{minted1}
\usepackage[
  contentBlocks,
  rawAttribute,
  texMathDollars,
...
\newcommand{\codeblockwrapper}[5]{
  \begin{tcolorbox}[
    ...
    \inputminted[ignorelexererrors=true,fontsize=\footnotesize,breaklines=true,linenos=false,highlightcolor=codeHighlightBg,#5]{#2}{#1}
  \end{tcolorbox}
}
...
\newcommand{\codeblockplain}[1]{
  \begin{tcolorbox}[
    ...
    \inputminted[ignorelexererrors=true,fontsize=\footnotesize,breaklines=true,linenos=false]{text}{#1}
  \end{tcolorbox}
}
...
%   linenos=false,
%   style=default,
%   highlightcolor=codeHighlightBg
% }
