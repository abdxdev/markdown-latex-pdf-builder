...
\newcommand{\creditblock}{
  \begin{center}
    ...
    \footnotesize
    \LaTeX{} Document by abd, more @ \href{https://github.com/abdxdev/md2lualatex}{github.com/abdxdev/md2lualatex} \\
...
\newcommand{\sectionnumspace}{1em}
\newcommand{\subsectionnumspace}{1em}
\newcommand{\subsubsectionnumspace}{1em}

\newcommand{\suppressnumbering}{
  \renewcommand{\thesection}{}
  \renewcommand{\thesubsection}{}
  \renewcommand{\thesubsubsection}{}
  \renewcommand{\sectionnumspace}{0em}
  \renewcommand{\subsectionnumspace}{0em}
  \renewcommand{\subsubsectionnumspace}{0em}
}
@@HEADING_NUMBERING@@

\titleformat{\section}
{\LARGE\bfseries}{\thesection}{\sectionnumspace}{}
\titleformat{\subsection}
{\Large\bfseries}{\thesubsection}{\subsectionnumspace}{}
\titleformat{\subsubsection}
{\large\bfseries}{\thesubsubsection}{\subsubsectionnumspace}{}
