...
\usepackage[contentBlocks,rawAttribute,texMathDollars,pipeTables,html,fencedCode,strikeThrough,superscripts,subscripts,inlineNotes,definitionLists]{markdown}
\usepackage{endnotes}
